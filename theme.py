...
.ed p{margin:0;font-size:1.0312rem;color:#4d4638;max-width:60ch}
...
.pub p{font-size:0.9062rem;color:#4d4638;margin:0 0 14px}
...
.pubintro p{font-size:1.0625rem;color:#4d4638}
...
.sub .lede{margin:0 auto 28px;color:#5b5344;font-size:1rem;max-width:48ch}
...
.subcard input[type=email]{flex:1 1 9.4rem;padding:11px 12px;font-size:0.9062rem;
...
.subnote{margin:26px 0 0;font-size:0.8125rem;color:#8f8571}
.subnote a{text-decoration:underline}

footer{padding:34px 0 66px;font-size:0.7188rem;color:#8f8571;display:flex;
...
.ed-head h1{font-size:2.625rem;margin:0 0 12px;line-height:1.12;letter-spacing:-0.024em;
  font-weight:400}
.ed-head .dek{font-size:1.0938rem;color:#4d4638;max-width:58ch;margin:0 auto 14px}
...
.ed-toc{margin:26px 0 0;border-top:3px solid #cec5b2;padding:.75rem 0 .9rem}
...
.ed-toc li+li::before{content:"·";color:#b9ae99}
.ed-toc a{font-size:.8125rem;line-height:1.7;color:#5b5344;
  border-bottom:1px solid transparent}
.ed-toc a:hover{color:#1a1713;border-bottom-color:#1a1713}
